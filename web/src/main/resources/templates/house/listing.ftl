                                     ...
                                     <div class="size">
                                         <div class="form-group">
                                             <select name="size" id="size">
                                                 ...
                                                 <option value=2<#if (vo.pageSize) == 2>   selected </#if>  >2</option>
                                                 <option value=5<#if (vo.pageSize) == 5>   selected </#if> >5</option>
 ...
 <script  type="text/javascript" >
     ...
     $(document).ready(function() {
      ...
      $('#sorting').change(function() {
          ...
          window.location.href=  "/house/list?sort="+type+"&name=" + "${(vo.name)!}" + "&type=" + "${(vo.type)!0}" +"&pageSize=" + "${(vo.pageSize)!}";})
     $('#size').change(function() {
         var type =  $(this).val();
         if (!type) {
             return;
         }
         window.location.href=  "/house/list?sort="+ "${(vo.sort)!}"+"&name=" + "${(vo.name)!}" + "&type=" + "${(vo.type)!0}" +"&pageSize=" + type;
     })
