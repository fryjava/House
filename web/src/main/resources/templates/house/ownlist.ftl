                ...
                <section id="sidebar">
                    ...
                    <aside>
                        <ul class="sidebar-navigation">
                           ...
                           <li <#if pageType != "book">  class="active" </#if> >
                                <a href="/house/ownlist"><i class="fa fa-home"></i><span>我的房产信息</span></a></li>
                            <li <#if  pageType == "book"> class="active" </#if>>
                                <a href="/house/bookmarked"><i class="fa fa-heart"></i><span>房产收藏 </span></a></li>
                        </ul>
                    </aside>
                </section><!-- /#sidebar -->
            </div><!-- /.col-md-3 -->
