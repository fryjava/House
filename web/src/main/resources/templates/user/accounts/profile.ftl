                        ...
                        <div class="account-profile">
                            <div class="row">
                                <div class="col-md-3 col-sm-3">
                                    ...
                                    <img alt="" class="image" src="http://192.168.1.150/group1/M00/00/00/${(loginUser.avatar)!}">
                                </div>
                                <div class="col-md-9 col-sm-9">
                                    <form role="form" id="form-account-profile" method="post" action="/accounts/profile/changeUser">
